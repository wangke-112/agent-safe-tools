...
[![CI](https://github.com/yourname/agent-safe-tools/actions/workflows/ci.yml/badge.svg)](https://github.com/yourname/agent-safe-tools/actions/workflows/ci.yml)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](./LICENSE)

给 AI Agent 用的**安全只读工具集**。面向任何支持 MCP 的宿主（Codex / Claude Code / OpenCode / Cursor 等）。

核心理念：**把安全红线从提示词下沉到代码**——不靠模型自觉，靠校验强制。
...
```bash
git clone https://github.com/yourname/agent-safe-tools.git
cd agent-safe-tools
