...
- `safe-mysql-mcp`：默认只读的 MySQL MCP Server
  ...
  - 15 个工具：ping / current_database / query / execute / explain / list_databases / list_tables / list_columns / describe_table / list_indexes / show_create_table / table_info / table_count / sample_table / list_profiles
  - 13 个单元测试
